Locales['pt'] = {
    ...
    ['time_unfrozenc'] = 'O tempo já não está parado.',
    ...
    ['blackout_enabledc'] = 'Apagão está agora ativado.',
    ['blackout_disabled'] = 'Apagão está agora desativado.',
    ['blackout_disabledc'] = 'Apagão está agora desativado.',
    ...
    ['not_access'] = 'Erro: Não tens acesso a este comando.',
    ['not_allowed'] = 'Erro: Não tens acesso a este comando.',
