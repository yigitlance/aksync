Locales['fr'] = {
    ['time_frozenc'] = 'Le temps est maintenant mis en pause.',
    ['time_unfrozenc'] = 'Le temps n\'est plus en pause.',
    ...
    ['time_morning'] = 'Heure fixée au matin.',
    ['time_noon'] = 'Heure fixée à midi.',
    ['time_evening'] = 'Heure fixée au soir.',
    ['time_night'] = 'Heure fixée à la nuit.',
    ['time_change'] = 'L\'heure est fixée à %s:%s.',
    ['time_changec'] = 'L\'heure est fixée à : %s!',
    ['time_invalid'] = 'Syntaxe invalide, la syntaxe correcte est : /time <heure> <minute> !',
    ['time_invalidc'] = 'Erreur : syntaxe invalide. Utilisez : /time <heure> <minute> à la place !',
    ['time_access'] = 'Accès à la commande /time refusé.',
    ['dynamic_weather_disabled'] = 'Les changements météorologiques sont maintenant désactivés.',
    ['dynamic_weather_enabled'] = 'Les changements météorologiques sont maintenant activés.',
    ...
    ['weather_invalid_syntaxc'] = 'Erreur : syntaxe invalide. Utilisez : /weather <météo> à la place !',
    ['weather_updated'] = 'La météo a été mise à jour.',
    ['weather_invalid'] = 'Météo invalide, les météos valables sont : \nEXTRASUNNY CLEAR NEUTRAL SMOG FOGGY OVERCAST CLOUDS CLEARING RAIN THUNDER SNOW BLIZZARD SNOWLIGHT XMAS HALLOWEEN ',
    ['weather_invalidc'] = 'Erreur : météo non valable, les types de temps valables sont : \nEXTRASUNNY CLEAR NEUTRAL SMOG FOGGY OVERCAST CLOUDS CLEARING RAIN THUNDER SNOW BLIZZARD SNOWLIGHT XMAS HALLOWEEN ',
    ['weather_willchangeto'] = 'La météo va changer pour : %s.',
    ['weather_accessdenied'] = 'Accès à la commande /weather refusé.',
    ['blackout_enabled'] = 'Le blackout est maintenant activé.',
    ['blackout_enabledc'] = 'Le blackout est maintenant activé.',
    ['blackout_disabled'] = 'Le blackout est maintenant désactivé.',
    ['blackout_disabledc'] = 'Le blackout est maintenant désactivé.',
    ...
    ['not_allowed'] = 'Erreur : vous n\'êtes pas autorisé à utiliser cette commande.',
